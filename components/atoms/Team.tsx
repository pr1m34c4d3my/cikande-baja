    ...
    <>
      {teams.map((v: TeamList, index: number) => {
        return (
          ...
          >
            <figure className="w-[300px] h-[400px] bg-white overflow-hidden relative rounded-2xl">
              <Image
                className="w-full object-cover absolute -top-[10px]"
                src={v.image}
            ...
            <div className="p-5">
              ...
              <Link href={v.handphone} target="_blank">
