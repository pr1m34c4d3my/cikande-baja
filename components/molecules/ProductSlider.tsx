...
const ProductSlider = ({
  ...
  return (
    <div className="max-w-[1170px] h-[400px] bg-white rounded-2xl flex flex-col hover:scale-110 shadow-lg hover:shadow-2xl ease-out duration-200 p-3 justify-center overflow-hidden border-[#D1D1D1] border-[1px]">
